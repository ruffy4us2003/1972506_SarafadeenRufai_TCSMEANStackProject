...
//          else if (urlDetails == "/store")  {
                      
//          let data = url.parse(urlDetails,true).query; // To take the value from url 
//         // data.toString();
//          console.log("The data" + data.toString());
//          // Get each of the values from url 
...
//          //To store all value as a single object
//          let userInput = {"empId": data.empId, "taskId": data.taskId, "task": data.task, "deadline": data.deadline };
         
//         //  console.log(userInput.toString());
//         //  console.log("The employee Id is " + userInput.empId);
//         // //  res.write(userInput);
//         //  res.end("The employee Id is " + userInput.empId);
         
//          // convert to object 
//             let urlData = JSON.parse(userInput);
           
//             console.log("The dataToObject is " + urlData);
